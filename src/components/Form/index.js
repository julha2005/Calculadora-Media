...
import ResultMedia from "./CalcularMedia/Index.js";
...
export default function Form(){
    ...
    const[nota2, setNota2]=useState(null) // estado para armazenar o peso
    ...
    return(
        ...
        {/* faz com que, ao clicar em qqr lugar da tela o teclado feche */}
            ...
            <TextInput style={styles.input} placeholder="ex: Port. Mat" keyboardType="numeric"/>
            <Text style={styles.errorMessage}>{errorMessage}</Text>

            <Text style={styles.formLabel}>Nota 1</Text>
            <TextInput style={styles.input} onChangeText={setNota1} value={nota1}placeholder="De 0 a 10" keyboardType="numeric"/>
            <Text style={styles.errorMessage}>{errorMessage}</Text>


            <Text style={styles.formLabel}>Nota 2</Text>
            <TextInput style={styles.input} onChangeText={setNota2} value={nota2} placeholder="De 0 a 10" keyboardType="numeric"/>
            <Text style={styles.errorMessage}>{errorMessage}</Text>

            <Text style={styles.formLabel}>Nota 3</Text>
            <TextInput style={styles.input} onChangeText={setNota3} value={nota3} placeholder="De 0 a 10" keyboardType="numeric"/>
            <Text style={styles.errorMessage}>{errorMessage}</Text>

            <Text style={styles.formLabel}>Nota 4</Text>
            <TextInput style={styles.input} onChangeText={setNota4} value={nota4} placeholder="De 0 a 10" keyboardType="numeric"/>
            <Text style={styles.errorMessage}>{errorMessage}</Text>
